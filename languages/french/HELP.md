...
- **Confirmer le dossier d'installation** : vérifie que Smart Citizen pointe bien vers la copie de Star Citizen à laquelle vous jouez réellement. Si votre PC contient plusieurs installations (un dossier de bibliothèque déplacé, un second disque, les restes d'une réinstallation), l'application peut très bien écrire dans celle que le lanceur RSI ne démarre jamais : l'application signale une réussite, mais rien ne change en jeu. Ce bouton recherche toutes les installations possibles et vous indique celle que le lanceur utilise vraiment, en lisant le journal du lanceur plutôt qu'en devinant d'après les noms de dossiers. Chaque installation trouvée est affichée avec ses justificatifs, et **Utiliser cette installation** y redirige Smart Citizen en un clic. Si votre installation se trouve à un emplacement inhabituel, **Analyser tous les disques** effectue une recherche plus lente et plus approfondie.
...
- **L'application réussit mais le jeu semble inchangé** : vous avez peut-être plusieurs installations de Star Citizen, Smart Citizen pointant vers celle que vous ne lancez pas. Cliquez sur **Confirmer le dossier d'installation** dans l'onglet **Paramètres** : il nomme l'installation réellement utilisée par le lanceur RSI et redirige l'application en un clic.
