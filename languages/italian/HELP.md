...
- **Conferma posizione installazione** — verifica che Smart Citizen punti alla copia di Star Citizen con cui giochi davvero. Se sul PC hai più di un'installazione (una cartella della libreria spostata, un secondo disco, i residui di una reinstallazione), l'app può scrivere proprio in quella che il launcher RSI non avvia mai: l'applicazione segnala il successo, ma in gioco non cambia nulla. Questo pulsante trova ogni installazione rilevabile e ti indica quella che il launcher usa davvero, leggendo il registro del launcher invece di tirare a indovinare dai nomi delle cartelle. Ogni installazione trovata è elencata con le sue prove, e **Usa questa installazione** vi reindirizza Smart Citizen con un clic. Se la tua installazione si trova in un percorso insolito, **Analizza tutti i dischi** esegue una ricerca più lenta e approfondita.
...
- **L'applicazione riesce ma il gioco sembra invariato** — Potresti avere più installazioni di Star Citizen, con Smart Citizen puntato su quella che non avvii. Fai clic su **Conferma posizione installazione** nella **scheda Configurazione**: indica l'installazione che il launcher RSI usa davvero e reindirizza l'app con un clic.
