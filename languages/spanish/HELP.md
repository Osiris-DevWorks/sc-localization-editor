...
- **Confirmar la ubicación**: comprueba que Smart Citizen apunta a la copia de Star Citizen con la que juegas realmente. Si tienes más de una instalación en el PC (una carpeta de biblioteca movida, un segundo disco, restos de una reinstalación), la aplicación puede estar escribiendo justo en la que el lanzador RSI nunca inicia: aplicar informa de éxito, pero en el juego no cambia nada. Este botón busca todas las instalaciones que puede y te dice cuál usa realmente el lanzador, leyendo el registro del propio lanzador en lugar de adivinar por los nombres de las carpetas. Cada instalación encontrada se muestra con sus pruebas, y **Usar esta instalación** redirige Smart Citizen a ella con un clic. Si tu instalación está en un sitio poco habitual, **Analizar todas las unidades** hace una búsqueda más lenta y profunda.
...
- **Aplicar dice que funcionó pero el juego no cambia**: puede que tengas más de una instalación de Star Citizen y que Smart Citizen apunte a la que no inicias. Pulsa **Confirmar la ubicación** en la pestaña **Configuración**: indica la instalación que usa realmente el lanzador RSI y redirige la aplicación con un clic.
