...
- **Apply says it worked but the game looks unchanged** — You may have more than one Star Citizen install, with Smart Citizen pointed at the one you don't launch. Click **Confirm Install Location** on the **Config Tab**: it names the install the RSI Launcher actually uses and repoints the app in one click.
